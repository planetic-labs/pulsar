...
print(f"   {token}")
print("\n3. Готовые ссылки для входа и проверки:")
print(f"   Вход по прямой ссылке: http://127.0.0.1:8000/?token={token}")
print(f"   Или вставьте этот токен на странице входа: http://127.0.0.1:8000/login")
