...
from app.config import get_sqlite_settings, get_qdrant_settings
                ...
                if embedding:
                    ...
                    if results:
                        ...
                        if score >= threshold:
                            ...
                            execute_with_retry(
                                settings.db_path,
                                "INSERT INTO speakers (video_id, speaker_tag, name) VALUES (?, ?, ?) ON CONFLICT(video_id, speaker_tag) DO UPDATE SET name = EXCLUDED.name",
